...
class MoleculeGenerator(object):
    ...
    def forward(
        ...
        **kwargs
        ...
        data = self.data
        input_grids, cond_grids, input_structs, cond_structs, transforms,_,feats \
            = data.forward(interpolate=interpolate, spherical=spherical)
        ...
        for example_idx, sample_idx in itertools.product(
            ...
            if need_real_input_mol:
                ...
                if uff_minimize:
                    ...
                    input_uff_mol = \
                        input_lig_mol.uff_minimize(rec_mol=input_rec_mol)
                ...
                if grid_needs_fit: # perform atom fitting
                    ...
                    if add_bonds: # do bond adding
                        ...
                        if uff_minimize: # do UFF minimization
                            ...
                            fit_uff_mol = \
                                fit_add_mol.uff_minimize(rec_mol=fit_add_mol)
